...
public class S3AFileSystem extends FileSystem {
  ...
  private static String metricsname="S3AFileSystemMetrics";
  ...
  public void initialize(URI name, Configuration originalConf)
    ...
    try {
      ...
      S3AFileSystemMetricsSystem.fileSystemStarted();
      S3AFileSystemMetricsSystem.registerSource(metricsname,null,instrumentation);
  ...
  public void close() throws IOException {
    S3AFileSystemMetricsSystem.unregisterSource(metricsname);
    S3AFileSystemMetricsSystem.fileSystemClosed();
