 ...
 * lookup failures.
 */
@Metrics(about = "Metrics for S3a", context = "s3a")
...
public class S3AInstrumentation implements MetricsSource{
  ...
  public static final String CONTEXT = "s3a";
  ...
  public S3AInstrumentation registerWith(MetricsSystem ms){
    return ms.register(CONTEXT,null,this);
  }
